...
cols = ['time','temperature','heat_index','humidity','pressure','wind_direction','wind_speed','precipitation','conditions']
...
remove_unit_cols = ['temperature','heat_index','humidity','pressure']
...
scaling_cols = ['temperature','heat_index','pressure','wind_speed']
...
df.drop(['precipitation','conditions','time'],axis=1,inplace=True)
